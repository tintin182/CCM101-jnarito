...
| **ChatGPT and Claude**    | I used both of these AI tools to help correct grammar, improve the clarity of some sentences, and explain or clarify ideas that I encountered while working on the activity |
...
Adobe. (n.d.). *Adobe XD* [Computer software]. https://www.adobe.com/products/xd.html

Anthropic. (n.d.). *Claude* [Large language model]. https://claude.ai/

Canonical Ltd. (n.d.). *Ubuntu* [Operating system]. https://ubuntu.com/

Git. (n.d.). *Git* [Version control system]. https://git-scm.com/

GitHub. (n.d.). *GitHub* [Code hosting platform]. https://github.com/

KillerCoda. (n.d.). *KillerCoda* [Cloud-based learning platform]. https://killercoda.com/
